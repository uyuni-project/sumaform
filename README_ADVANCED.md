...
- `4.4-released`   (latest released Maintenance Update for SUSE Manager 4.4 and Tools)
...
- `4.4-nightly` (corresponds to the Build Service project Devel:Galaxy:Manager:4.4)
- `4.4-beta`    (corresponds to the Build Service project SUSE:SLE-15-SP5:Update:Products:Manager44)
- `head` (corresponds to the Build Service project Devel:Galaxy:Manager:Head, for `server` and `proxy`only works with SLE15SP5 image)
