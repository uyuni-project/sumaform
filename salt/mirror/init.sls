...
minima:
  archive.extracted:
    - name: /usr/bin
    - source: https://github.com/uyuni-project/minima/releases/download/v0.9/minima-linux-amd64.tar.gz
    - source_hash: https://github.com/uyuni-project/minima/releases/download/v0.9/minima-linux-amd64.tar.gz.sha512
    - archive_format: tar
