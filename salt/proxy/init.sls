...
{% elif '4.3' in grains.get('product_version') %}
  ...
  {% endif %}
{% else %}
    {% set client_tools_repo =  grains.get("mirror") | default("dist.suse.de", true) ~ '/ibs/Devel:/Galaxy:/Manager:/Head:/MLMTools-Beta-SLE15/images/repo/ManagerTools-Beta-SLE15-Pool-x86_64-Media1/' %}
{% endif %}
