...
#   pkgrepo.managed:
#     - baseurl: http://{{ grains.get("mirror") | default("dist.suse.de/ibs", true) }}/SUSE/Products/SUSE-Manager-Proxy/5.0/{{ grains.get("cpuarch") }}/product
#     - refresh: True
#     - gpgkey: http://{{ grains.get("mirror") | default("dist.suse.de/ibs", true) }}/SUSE/Products/SUSE-Manager-Proxy/5.0/{{ grains.get("cpuarch") }}/product/repodata/repomd.xml.key
# container_utils_updates_repo:
#   pkgrepo.managed:
#     - baseurl: http://{{ grains.get("mirror") | default("dist.suse.de/ibs", true) }}/SUSE/Updates/SUSE-Manager-Proxy/5.0/{{ grains.get("cpuarch") }}/update
#     - refresh: True
#     - gpgkey: http://{{ grains.get("mirror") | default("dist.suse.de/ibs", true) }}/SUSE/Updates/SUSE-Manager-Proxy/5.0/{{ grains.get("cpuarch") }}/update/repodata/repomd.xml.key
{% endif %}
...
# manager50_repo:
#   pkgrepo.managed:
#     - baseurl: http://{{ grains.get("mirror") | default("dist.suse.de/ibs", true) }}/Devel:/Galaxy:/Manager:/5.0/images/repo/SUSE-Manager-Proxy-5.0-POOL-{{ grains.get("cpuarch") }}-Media1
#     - refresh: True
#     - gpgkey: http://{{ grains.get("mirror") | default("dist.suse.de/ibs", true) }}/Devel:/Galaxy:/Manager:/5.0/images/repo/SUSE-Manager-Proxy-5.0-POOL-{{ grains.get("cpuarch") }}-Media1/repodata/repomd.xml.key
{% endif %}
