...
manager52_repo:
  pkgrepo.managed:
    - baseurl: http://{{ grains.get("mirror") | default("dist.suse.de/ibs", true) }}/Devel:/Galaxy:/Manager:/5.2:/MLM-Products-SLE15/images/repo/SUSE-Multi-Linux-Manager-Server-SLE-5.2-POOL-{{ grains.get("cpuarch") }}-Media1
    - refresh: True
    - gpgkey: http://{{ grains.get("mirror") | default("dist.suse.de/ibs", true) }}/Devel:/Galaxy:/Manager:/5.2:/MLM-Products-SLE15/images/repo/SUSE-Multi-Linux-Manager-Server-SLE-5.2-POOL-{{ grains.get("cpuarch") }}-Media1/repodata/repomd.xml.key
{% endif %}
