...
{% if grains.get('proxy_containerized') or grains.get('testsuite') %}
...
{% if '4.3-nightly' == grains['product_version'] or '4.3-pr' == grains['product_version'] or '4.3-VM-nightly' == grains['product_version'] %}
