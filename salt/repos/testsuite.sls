...
uyuni_key_for_fake_packages:
  ...
  {%- endif %}
      ...
      {% if not ('SL-Micro' == grains['osfullname'] and '6.0' in grains['osrelease']) and not ('openSUSE Leap Micro' == grains['osfullname'] and '5.5' == grains['osrelease']) %}
...
test_repo_deb_pool:
  pkgrepo.managed:
    ...
    {% endif %}
  {% elif 'build_host' in grains.get('roles') %}
