...
class HelmChart:
    ...
    def __init__(self, oci_chart_file: str, oci_path: str, file_output: str, devel: bool = False):
    ...
    def sync(self):
        ...
        lines = [f'export {k.upper()}="{v}"' for k, v in oci_params.items() if isinstance(v, (str, int))]
