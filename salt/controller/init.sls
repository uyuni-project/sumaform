...
health_check_repo:
  pkgrepo.managed:
    - baseurl: http://{{ grains.get("mirror") | default("download.opensuse.org", true) }}/repositories/systemsmanagement:/Uyuni:/healthcheck/{{ grains.get("osrelease") }}
    - gpgkey: http://{{ grains.get("mirror") | default("download.opensuse.org", true) }}/repositories/systemsmanagement:/Uyuni:/healthcheck/{{ grains.get("osrelease") }}/repodata/repomd.xml.key
    - gpgcheck: 0
    - refresh: True
