...
module "controller" {
  ...
  grains = {
    ...
    slemicro60_minion    = length(var.slemicro60_minion_configuration["hostnames"]) > 0 ? var.slemicro60_minion_configuration["hostnames"][0] : null
    slemicro60_sshminion = length(var.slemicro60_sshminion_configuration["hostnames"]) > 0 ? var.slemicro60_sshminion_configuration["hostnames"][0] : null
