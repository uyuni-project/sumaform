...
module "controller" {
  ...
  grains = {
    ...
    sle160_minion            = length(var.sle160_minion_configuration["hostnames"]) > 0 ? var.sle160_minion_configuration["hostnames"][0] : null
    sle160_sshminion         = length(var.sle160_sshminion_configuration["hostnames"]) > 0 ? var.sle160_sshminion_configuration["hostnames"][0] : null
