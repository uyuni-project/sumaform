...
resource "libvirt_volume" "sles15_volume" {
  ...
  source = "http://${var.use_mirror_images ? var.mirror : "download.suse.de"}/ibs/Devel:/Galaxy:/Terraform:/Images/images/sles15.x86_64.qcow2"
...
resource "libvirt_volume" "sles15sp1_volume" {
  ...
  source = "http://${var.use_mirror_images ? var.mirror : "download.suse.de"}/ibs/Devel:/Galaxy:/Terraform:/Images/images/sles15sp1.x86_64.qcow2"
...
resource "libvirt_volume" "sles15sp2_volume" {
  ...
  source = "http://${var.use_mirror_images ? var.mirror : "download.suse.de"}/ibs/Devel:/Galaxy:/Terraform:/Images/images/sles15sp2.x86_64.qcow2"
...
resource "libvirt_volume" "sles11sp4_volume" {
  ...
  source = "http://${var.use_mirror_images ? var.mirror : "download.suse.de"}/ibs/Devel:/Galaxy:/Terraform:/Images/images/sles11sp4.x86_64.qcow2"
...
resource "libvirt_volume" "sles12_volume" {
  ...
  source = "http://${var.use_mirror_images ? var.mirror : "download.suse.de"}/ibs/Devel:/Galaxy:/Terraform:/Images/images/sles12.x86_64.qcow2"
...
resource "libvirt_volume" "sles12sp1_volume" {
  ...
  source = "http://${var.use_mirror_images ? var.mirror : "download.suse.de"}/ibs/Devel:/Galaxy:/Terraform:/Images/images/sles12sp1.x86_64.qcow2"
...
resource "libvirt_volume" "sles12sp2_volume" {
  ...
  source = "http://${var.use_mirror_images ? var.mirror : "download.suse.de"}/ibs/Devel:/Galaxy:/Terraform:/Images/images/sles12sp2.x86_64.qcow2"
...
resource "libvirt_volume" "sles12sp3_volume" {
  ...
  source = "http://${var.use_mirror_images ? var.mirror : "download.suse.de"}/ibs/Devel:/Galaxy:/Terraform:/Images/images/sles12sp3.x86_64.qcow2"
...
resource "libvirt_volume" "sles12sp4_volume" {
  ...
  source = "http://${var.use_mirror_images ? var.mirror : "download.suse.de"}/ibs/Devel:/Galaxy:/Terraform:/Images/images/sles12sp4.x86_64.qcow2"
