...
variable "images" {
  ...
  default = ["opensuse422", "sles12sp3", "sles12sp2", "sles12sp1", "sles12", "sles11sp4", "sles11sp3"]
  type = "list"
}
...
variable "image_locations" {
  ...
  default = {
    opensuse422 = "https://download.opensuse.org/repositories/systemsmanagement:/sumaform:/images:/openstack/images/opensuse422.x86_64.qcow2"
