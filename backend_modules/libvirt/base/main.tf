...
locals {
  ...
  image_urls = {
    ...
    amazonlinux2023o         = "${var.use_mirror_images ? "http://${var.mirror}" : "http://cdn.amazonlinux.com"}/al2023/os-images/2023.11.20260413.0/kvm/al2023-kvm-2023.11.20260413.0-kernel-6.1-x86_64.xfs.gpt.qcow2"
    ...
    libertylinux9o           = "${var.use_mirror_images ? "http://${var.mirror}" : "http://zenon.suse.de"}/download/suma/sll9.7-cloud.qcow2"
    libertylinux10o          = "${var.use_mirror_images ? "http://${var.mirror}" : "http://zenon.suse.de"}/download/suma/sll10.1-cloud.qcow2"
    ...
    oraclelinux8o            = "${var.use_mirror_images ? "http://${var.mirror}" : "http://yum.oracle.com"}/templates/OracleLinux/OL8/u10/x86_64/OL8U10_x86_64-kvm-b271.qcow2"
    oraclelinux9o            = "${var.use_mirror_images ? "http://${var.mirror}" : "http://yum.oracle.com"}/templates/OracleLinux/OL9/u7/x86_64/OL9U7_x86_64-kvm-b269.qcow2"
    oraclelinux10o           = "${var.use_mirror_images ? "http://${var.mirror}" : "http://yum.oracle.com"}/templates/OracleLinux/OL10/u1/x86_64/OL10U1_x86_64-kvm-b270.qcow2"
    ...
    rocky10o                 = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.rockylinux.org"}/pub/rocky/10/images/x86_64/Rocky-10-GenericCloud-Base.latest.x86_64.qcow2"
    ...
    sles160o                 = "${var.use_mirror_images ? "http://${var.mirror}" : "http://dist.suse.de"}/install/SLES-16-GM/SLES-16.0-Minimal-VM.x86_64-Cloud-GM.qcow2"
