...
locals {
  ...
  image_urls = {
    ...
    amazonlinux2o = "${var.use_mirror_images ? "http://${var.mirror}" : "https://cdn.amazonlinux.com"}/os-images/2.0.20210525.0/kvm/amzn2-kvm-2.0.20210525.0-x86_64.xfs.gpt.qcow2"
