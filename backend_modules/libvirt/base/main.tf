...
locals {
  ...
  image_urls = {
    ...
    sles15sp2                = "${var.use_mirror_images ? "http://${var.mirror}" : "http://dist.nue.suse.com"}/ibs/Devel:/Galaxy:/Terraform:/Images/images/sles15sp2.x86_64.qcow2"
    sles15sp2o               = "${var.use_mirror_images ? "http://${var.mirror}" : "http://dist.nue.suse.com"}/install/SLE-15-SP2-JeOS-GM/SLES15-SP2-JeOS.x86_64-15.2-OpenStack-Cloud-GM.qcow2"
