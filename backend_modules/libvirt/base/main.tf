...
locals {
  ...
  image_urls = {
    ...
    slmicro6o                = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.opensuse.org"}/repositories/systemsmanagement:/sumaform:/images:/microos/images_slmicro6/SL-Micro.x86_64-sumaform.qcow2"
