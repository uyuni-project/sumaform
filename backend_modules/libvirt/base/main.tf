...
locals {
  ...
  image_urls = {
    ...
    opensuse153o = "${var.use_mirror_images ? "http://${var.mirror}" : "http://suse.uni-leipzig.de/pub/ftp.opensuse.org/opensuse"}/distribution/leap/15.3/appliances/openSUSE-Leap-15.3-JeOS.x86_64-OpenStack-Cloud.qcow2"
