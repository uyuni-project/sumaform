...
locals {
  ...
  image_urls = {
    ...
    sles15sp3o   = "${var.use_mirror_images ? "http://${var.mirror}" : "https://download.suse.de"}/install/SLE-15-SP3-JeOS-Beta1/SLES15-SP3-JeOS.x86_64-15.3-OpenStack-Cloud-Beta1.qcow2"
