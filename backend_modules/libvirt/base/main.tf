...
locals {
  ...
  image_urls = {
    ...
    sles15sp4o      = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.suse.de"}/install/SLE-15-SP4-Minimal-Snapshot-202205-1/SLES15-SP4-Minimal-VM.x86_64-OpenStack-Cloud-Snapshot-202205-1.qcow2"
