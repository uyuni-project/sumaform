...
locals {
  ...
  image_urls = {
    ...
    sles15sp5o      = "${var.use_mirror_images ? "http://${var.mirror}" : "http://download.suse.de"}/install/SLE-15-SP5-Minimal-Alpha-202210-2/SLES15-SP5-Minimal-VM.x86_64-OpenStack-Cloud-Alpha-202210-2.qcow2"
