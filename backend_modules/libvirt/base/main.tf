...
locals {
  ...
  image_urls = {
    ...
    amazonlinux2023o         = "${var.use_mirror_images ? "http://${var.mirror}" : "http://cdn.amazonlinux.com"}/al2023/os-images/latest/kvm/al2023-kvm-2023.10.20260330.0-kernel-6.1-x86_64.xfs.gpt.qcow2"
