locals {
  ...
  provider_settings = merge({
    ...
    contains(var.roles, "server_containerized") ? { memory = 20480, vcpu = 4 } : {},
    contains(var.roles, "server") && lookup(var.base_configuration, "testsuite", false) ? { memory = 8192, vcpu = 4 } : {},
    contains(var.roles, "server_containerized") && lookup(var.base_configuration, "testsuite", false) ? { memory = 20480, vcpu = 4 } : {},
