locals {
  ...
  x86_64_v2_images = ["almalinux9o", "amazonlinux2023o", "libertylinux9o", "openeuler2403o", "oraclelinux9o", "rocky9o", "slmicro60o", "slmicro61o"]
  ...
  combustion_data = templatefile("${path.module}/combustion", {
