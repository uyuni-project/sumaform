...
variable "images" {
  ...
  default     = ["centos7o", "rocky8o", "opensuse153o", "opensuse154o", "sles12sp4o", "sles12sp5o", "sles15sp3o", "sles15sp4o", "sles15sp5o", "ubuntu1804o", "ubuntu2004o", "ubuntu2204o", "amazonlinux2o", "almalinux8o"]
  type        = set(string)
}
