...
variable "images" {
  ...
  default     = [ "almalinux8o", "amazonlinux2o", "centos7o", "opensuse153o", "opensuse154o", "rocky8o", "rocky9o", "sles12sp4o", "sles12sp5o", "sles15sp3o", "sles15sp4o", "slemicro52-ign", "slemicro53-ign", "ubuntu1804o", "ubuntu2004o", "ubuntu2204o" ]
  type        = set(string)
}
