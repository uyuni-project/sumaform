...
/* data "aws_ami" "mlm-server-51-x86_64-ltd-paygo" {
  most_recent = true
...
data "aws_ami" "mlm-server-51-arm64-ltd-paygo" {
  most_recent = true
  name_regex  = "^suse-mlm-server-5-1-v[0-9].*(ltd).*$"
  owners      = ["679593333241"]
...
data "aws_ami" "mlm-proxy-51-arm64-byos" {
  most_recent = true
...
data "aws_ami" "mlm-proxy-51-x86_64-byos" {
  most_recent = true
  name_regex  = "^suse-mlm-proxy-5-1-byos-v"
  owners      = ["679593333241"]
